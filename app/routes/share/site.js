      ...
      res.data.items.forEach((item) => {
        items.push(
          RSVP.hash({
            ...
            msrc: utils.getShareImageSrc(site, item, 'preview', item.additional.public_share.shareid),
            small: utils.getShareImageSrc(site, item, 'small', item.additional.public_share.shareid),
            pid: item.id,
            info: item,
          })
        );
